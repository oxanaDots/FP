...
function NavMenu() {
  return (
    ...
    <nav className='flex no-underline gap-2 text-sm items-right font-normal'>
       ...
       <div className='no-underline '><NavLink to='/specify_role'className='no-underline bg-primary-dark px-4  text-secondary-light py-2 rounded-[20rem]'>Sign Up</NavLink></div>
